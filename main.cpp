...
int main(int argc, char** argv)
{
    ...
    if (argc >= 2 && std::string(argv[1]) == "decrypt") {
        std::string encodedPath = "./images/oizo_encoded.png";
        std::string outputPath  = "./images/oizo_decoded.png";

        if (argc >= 3 && std::string(argv[2]) == "gpu") {
            encodedPath = "./images/oizo_encoded_gpu.png";
            outputPath  = "./images/oizo_decoded_gpu.png";
        }
